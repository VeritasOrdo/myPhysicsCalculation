...
int main() {
    ...
    for(double properTimeSlice=0;properTimeSlice<100;properTimeSlice+=0.001) {
        ...
        //std::cout<<electronTrajectoryByAnalysisInATimeSlice.getElectronStateFinal().getParticleLorentzMomentum()<<std::endl;
    }
...
/*int main(){
    ...
    NumericalSolveOfMotionEquationWithInitPositionAndInitMomentum numericalSolutionOfMoleculeInCounterpropagatingLaser(
    timeBegin, timeInterval, stepLength, 
    [omega,fieldParameter1,fieldParameter2,electronMass](Dimension3Vector<double> y,Dimension3Vector<double> dydt,double t)->Dimension3Vector<double>{  
